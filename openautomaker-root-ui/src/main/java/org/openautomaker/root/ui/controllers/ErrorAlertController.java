...
import org.openautomaker.root.ui.remote.ErrorDetails;
...
public class ErrorAlertController {
	...
	public void prepareDialog() {
		abortText = GRootServices.getI18N().t(abortText);
		clearText = GRootServices.getI18N().t(clearText);
		continueText = GRootServices.getI18N().t(continueText);
		retryText = GRootServices.getI18N().t(retryText);
		ejectFilament1Text = GRootServices.getI18N().t(ejectFilament1Text);
		ejectFilament2Text = GRootServices.getI18N().t(ejectFilament2Text);
		dialogTitleText = GRootServices.getI18N().t(dialogTitleText);
