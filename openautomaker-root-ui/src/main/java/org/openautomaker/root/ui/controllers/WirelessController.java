...
import org.openautomaker.root.ui.remote.WifiStatusResponse;
...
public class WirelessController implements Initializable, Page {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		wirelessOff.setText(GRootServices.getI18N().t("wireless.offLabel"));
		wirelessOn.setText(GRootServices.getI18N().t("wireless.onLabel"));
		ssidLabel.setText(GRootServices.getI18N().t("wireless.ssidLabel"));
		passwordLabel.setText(GRootServices.getI18N().t("wireless.passwordLabel"));
		wirelessTitle.setText(GRootServices.getI18N().t("wireless.title"));
		savePrompt.setText(GRootServices.getI18N().t("common.savePrompt"));
		ssidField.setPromptText(GRootServices.getI18N().t("wireless.ssidPrompt"));
		passwordField.setPromptText(GRootServices.getI18N().t("wireless.passwordPrompt"));
