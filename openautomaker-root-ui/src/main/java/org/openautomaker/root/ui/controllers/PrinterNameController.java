...
public class PrinterNameController implements Initializable, Page {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		nameLabel.setText(GRootServices.getI18N().t("printerName.nameLabel"));
		nameTitle.setText(GRootServices.getI18N().t("printerName.title"));
		savePrompt.setText(GRootServices.getI18N().t("common.savePrompt"));
		nameField.setPromptText(GRootServices.getI18N().t("printerName.enterName"));
