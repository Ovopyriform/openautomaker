...
import org.openautomaker.root.ui.remote.PrintJobData;
import org.openautomaker.root.ui.remote.PrintJobListData;
...
public class PrintController implements Initializable, Page {
	...
	public void initialize(URL url, ResourceBundle rb) {
		pageNumberFormat = GRootServices.getI18N().t(pageNumberFormat);
		...
		reprintTitleText = GRootServices.getI18N().t(reprintTitleText);
		usbPrintTitleText = GRootServices.getI18N().t(usbPrintTitleText);
		loadingDetailsText = GRootServices.getI18N().t(loadingDetailsText);
		loadingTitleText = GRootServices.getI18N().t(loadingTitleText);
		noSuitableJobsTitleText = GRootServices.getI18N().t(noSuitableJobsTitleText);
		noSuitableJobsDetailsText = GRootServices.getI18N().t(noSuitableJobsDetailsText);
		noJobsTitleText = GRootServices.getI18N().t(noJobsTitleText);
		noJobsDetailsText = GRootServices.getI18N().t(noJobsDetailsText);
		noMediaTitleText = GRootServices.getI18N().t(noMediaTitleText);
		noMediaDetailsText = GRootServices.getI18N().t(noMediaDetailsText);
		noPrinterTitleText = GRootServices.getI18N().t(noPrinterTitleText);
		noPrinterDetailsText = GRootServices.getI18N().t(noPrinterDetailsText);
		errorTitleText = GRootServices.getI18N().t(errorTitleText);
		errorDetailsText = GRootServices.getI18N().t(errorDetailsText);
