...
import org.openautomaker.root.ui.remote.PurgeData;
import org.openautomaker.root.ui.remote.PurgeTarget;
...
public class PurgeController implements Initializable, Page {
	...
	public void initialize(URL url, ResourceBundle rb) {
		translateLabels(m1Title,
				...
				m2PurgeTempLabel,
				m2PurgeTempSuffix);
		purgePromptText = GRootServices.getI18N().t(purgePromptText);
		purgeUnavailableText = GRootServices.getI18N().t(purgeUnavailableText);
