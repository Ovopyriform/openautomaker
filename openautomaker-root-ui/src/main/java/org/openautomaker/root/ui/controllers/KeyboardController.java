...
"("
		...
		backspaceKey.setText(GRootServices.getI18N().t(backspaceKey.getText()));
		enterKey.setText(GRootServices.getI18N().t(enterKey.getText()));
		shiftKey.setText(GRootServices.getI18N().t(shiftKey.getText()));
		spaceKey.setText(GRootServices.getI18N().t(spaceKey.getText()));
		keyboardLowercaseText = GRootServices.getI18N().t(keyboardLowercaseText);
		keyboardUppercaseText = GRootServices.getI18N().t(keyboardUppercaseText);
