...
import org.openautomaker.root.ui.remote.FilamentDetails;
...
public class HomeController implements Initializable, Page {
	...
	private final String rightNozzleTitle = GRootServices.getI18N().t("common.rightNozzle");
	private final String leftNozzleTitle = GRootServices.getI18N().t("common.leftNozzle");
	private final String nozzlesTitle = GRootServices.getI18N().t("common.nozzles");
	private final String nozzleTitle = GRootServices.getI18N().t("common.nozzle");
	...
	private void updatePrinterStatus(PrinterStatusResponse printerStatus) {
		if (printerStatus != null) {
			...
			Platform.runLater(() -> {
				...
				modelLabel.setText(GRootServices.getI18N().t(md.model));
	...
	private void updatePrintStatus(PrinterStatusResponse printerStatus)
	{
		...
		if (jobStatusText.startsWith("heating-"))
			jobStatusText = GRootServices.getI18N().t("common." + jobStatusText.replace('-', '.'));
