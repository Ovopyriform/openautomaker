...
import org.openautomaker.root.ui.remote.HeadEEPROMData;
...
public class HeadParametersController implements Initializable, Page {
	...
	public void updateHeadEEPROMData(HeadEEPROMData headData)
	{
		...
		headTitleBold.setText(GRootServices.getI18N().t(prefix + ".titleBold"));
		headTitleLight.setText(GRootServices.getI18N().t(prefix + ".titleLight"));
		headTitleEdition.setText(GRootServices.getI18N().t(prefix + ".titleEdition"));
		headDescription.setText(GRootServices.getI18N().t(prefix + ".description"));
		headNozzlesDescription.setText(GRootServices.getI18N().t(prefix + ".nozzles"));
		headFeedsDescription.setText(GRootServices.getI18N().t(prefix + ".feeds"));
		String headIconText = "-fx-background-image: url(\"/image/" + GRootServices.getI18N().t(prefix + ".icon") + "\")";
		headIcon.setStyle(headIconText);
		...
		if (!typeCode.isEmpty()) {
			...
			headHoursField.setText(String.format("%d %s", (int) headData.getHourCount(), GRootServices.getI18N().t("unit.hours")));
			maxTempField.setText(String.format("%d %s", (int) headData.getMaxTemp(), GRootServices.getI18N().t("unit.temp")));
