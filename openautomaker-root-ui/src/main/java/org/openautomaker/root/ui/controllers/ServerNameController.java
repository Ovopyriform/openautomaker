...
public class ServerNameController implements Initializable, Page {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		nameLabel.setText(GRootServices.getI18N().t("serverName.nameLabel"));
		nameTitle.setText(GRootServices.getI18N().t("serverName.title"));
		savePrompt.setText(GRootServices.getI18N().t("common.savePrompt"));
		nameField.setPromptText(GRootServices.getI18N().t("serverName.enterName"));
