...
public class OpenProjectsPreference extends APreference<List<Path>>{
	...
	/**
	 * Checks if the given path is in the list of paths for this preference.
	 * 
	 * @param path - The path to check
	 * @return	boolean - true if the path is in the list, false otherwise
	 */
    ...
    /**
     * Replaces the stored paths with the given list.
     */
    public void setValue(List<Path> value) {
        paths = new ArrayList<>(value);
        writePaths();
    }
