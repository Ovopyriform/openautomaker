...
public final class RbxProjFile {
	...
	/**
	 * Returns the ZIP entry path for a printer type's GCode output.
	...
	/**
	 * Returns the ZIP entry path for a printer type's settings snapshot.
	...
	/**
	 * Returns the ZIP entry path for the printer type's GCode directory.
	...
	/** Strip characters that are invalid in ZIP entry path segments. */
