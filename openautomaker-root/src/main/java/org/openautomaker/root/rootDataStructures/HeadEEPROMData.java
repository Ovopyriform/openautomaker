	...
	public void updateFromPrinterData(String printerID)
	{
		...
		if (printerHead != null)
		{
			...
			if (nozzleCount > 1)
			{
				...
				leftNozzleZOverrun = RootServices.getPrinterUtils().deriveNozzle1OverrunFromOffsets(leftNozzleZOffset, rightNozzleZOffset);
				rightNozzleZOverrun = RootServices.getPrinterUtils().deriveNozzle2OverrunFromOffsets(leftNozzleZOffset, rightNozzleZOffset);
			}
			else
			{
				...
				rightNozzleZOverrun = RootServices.getPrinterUtils().deriveNozzle1OverrunFromOffsets(rightNozzleZOffset, rightNozzleZOffset);
			}
		}
	}
